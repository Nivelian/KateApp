...
import com.kate.config.Constants;
...
import com.kate.service.MailService;
import com.kate.service.UserService;
import com.kate.service.dto.UserDTO;
import com.kate.web.rest.vm.ManagedUserVM;
...
public class UserResource {
    ...
    /**
     * GET  /users/logged-user : get the logged user.
     *
     * @return the ResponseEntity with status 200 (OK) and with body the logged user, or with status 404 (Not Found)
     */
    @GetMapping("/users/logged-user")
    @Timed
    public ResponseEntity<UserDTO> getLoggedUser() {
        log.debug("REST request to get logged User");
